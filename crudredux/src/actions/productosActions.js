...
export function borrarProdcutoAction(id){
    return async (dispatch) => {
        ...
        try {
            ...
            console.log(error);
            dispatch(elinminarProductoError());
        }
    }
}
...
const elinminarProductoError = ()=> ({
    type: PRODUCTO_ELIMINARDO_ERROR,
    payload: true
});
...
export function editarProductoAction(producto) {
    return async (dispatch)=>{
        ...
        try {
            ...
            dispatch(eidtarProductoExito(producto));
        } catch (error) {
...
const eidtarProductoExito = producto => ({
